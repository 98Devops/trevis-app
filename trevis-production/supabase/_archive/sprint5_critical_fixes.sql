...
-- Fixes foreign key constraints and UNASSIGNED record cleanup
-- ═══════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- Get room records and property IDs
...
-- Test room deletion capability (commented out for safety)
/*
-- This should now work without foreign key constraint errors
-- DELETE FROM rooms WHERE id = 'some-test-room-id';
*/
